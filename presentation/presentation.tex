...
\begin{document}
	...
	\begin{frame}[shrink=5]{Mathematical Basis of Isolation Forest (P3)}
	...
	\begin{frame}[shrink=5]{iForest: Score Interpretation}
	...
	\begin{frame}[shrink=5]{iForest: Implementation Details}
		...
		\par
		\vspace{0.3em}
		\textbf{Result}: \textbf{11} students ($\approx 3\%$ of 372) flagged as anomalies
		\par
	...
	\begin{frame}[shrink=5]{Presenter 4: K-means Clustering - Introduction}
	...
	\begin{frame}[shrink=5]{K-means Algorithm: Steps 1-2}
	...
	\begin{frame}[shrink=5]{K-means Algorithm: Steps 3-4}
	...
	\begin{frame}[shrink=5]{K-means Objective Function}
	...
	\begin{frame}[shrink=5]{Selecting Optimal K: Elbow Method}
	...
	\begin{frame}[shrink=5]{Selecting Optimal K: Silhouette Score}
	...
	\begin{frame}[shrink=5]{Final K Selection and Implementation}
